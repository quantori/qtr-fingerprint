...
namespace qtr {
    ...
    public:
        ...
        [[nodiscard]] std::vector<IndexType>::const_iterator begin() const { return _indices.cbegin(); }

        [[nodiscard]] std::vector<IndexType>::const_iterator end() const { return _indices.cend(); }

        [[nodiscard]] std::size_t size() const { return _indices.size(); }
